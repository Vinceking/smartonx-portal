...
export default function ForgotPassword() {
  ...
  const onSubmit = async (values: z.infer<typeof schema>) => {
    try {
      ...
      form.setError('usernameOrEmail', { message: err.error || 'Failed to process request' });
    }
  };
          ...
          {isSuccess ? (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                If an account exists, we've sent a password reset link to your registered email address.
              </p>
